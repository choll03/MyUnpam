...
class myWindow extends JFrame implements ActionListener {
    ...
    public myWindow() {
        ...
        FileMenu.add(menuKali);
        FileMenu.add(menuBagi);
        FileMenu.addSeparator();
        FileMenu.add(menuKeluar);
...
class Perkalian extends JInternalFrame implements ActionListener {
    ...
    Perkalian () {
        ...
        setSize(300,220);
        setLocation((myWindow.MainWindowWidht - this.getSize().width) / 2, (myWindow.MainWindowHeight - this.getSize().height) / 2);
